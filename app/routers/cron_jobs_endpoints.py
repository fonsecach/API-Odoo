...
async def trigger_stale_opportunities_report(background_tasks: BackgroundTasks):
    """
    ...
    return {"message": "A geração do relatório de oportunidades estagnadas foi iniciada em background."}