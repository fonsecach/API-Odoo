...
def get_helpdesk_info_by_team_id(models, db, uid, password, team_id, limit=100, offset=0):
    try:
        helpdesk_info = models.execute_kw(
            db,
            uid,
...
def get_helpdesk_info_by_team_and_id(models, db, uid, password, team_id, ticket_id):
    try:
        helpdesk_info = models.execute_kw(
            db,
            uid,
